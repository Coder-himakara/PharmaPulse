...
var BarsIcon = React6.memo(React6.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var MegaMenu = React8.memo(React8.forwardRef(function(inProps, ref) {
  var mergeProps2 = useMergeProps();
  ...
  var _React$useState3 = React8.useState(null), _React$useState4 = _slicedToArray4(_React$useState3, 2), activeItemState = _React$useState4[0], setActiveItemState = _React$useState4[1];
  var _React$useState5 = React8.useState(null), _React$useState6 = _slicedToArray4(_React$useState5, 2), focused = _React$useState6[0], setFocused = _React$useState6[1];
  ...
  var _React$useState11 = React8.useState(false), _React$useState12 = _slicedToArray4(_React$useState11, 2), dirty = _React$useState12[0], setDirty = _React$useState12[1];
  var _React$useState13 = React8.useState(null), _React$useState14 = _slicedToArray4(_React$useState13, 2), processedItems = _React$useState14[0], setProcessedItems = _React$useState14[1];
  var _React$useState15 = React8.useState([]), _React$useState16 = _slicedToArray4(_React$useState15, 2), visibleItems = _React$useState16[0], setVisibleItems = _React$useState16[1];
  var _React$useState17 = React8.useState(null), _React$useState18 = _slicedToArray4(_React$useState17, 2), attributeSelectorState = _React$useState18[0], setAttributeSelectorState = _React$useState18[1];
  var _React$useState19 = React8.useState(false), _React$useState20 = _slicedToArray4(_React$useState19, 2), mobileActiveState = _React$useState20[0], setMobileActiveState = _React$useState20[1];
  var _React$useState21 = React8.useState(false), _React$useState22 = _slicedToArray4(_React$useState21, 2), focusTrigger = _React$useState22[0], setFocusTrigger = _React$useState22[1];
  var searchValue = React8.useRef("");
  var searchTimeout = React8.useRef(null);
  var elementRef = React8.useRef(null);
  var menubarRef = React8.useRef(null);
  var styleElementRef = React8.useRef(null);
  ...
  }), _useResizeListener2 = _slicedToArray4(_useResizeListener, 2), bindDocumentResizeListener = _useResizeListener2[0], unbindDocumentResizeListener = _useResizeListener2[1];
  ...
  var toggle = function toggle2(event) {
    ...
    if (mobileActiveState) {
      ...
      ZIndexUtils.set("menu", menubarRef.current, context && context.autoZIndex || PrimeReact2.autoZIndex, context && context.zIndex.menu || PrimeReact2.zIndex.menu);
      setTimeout(function() {
        show();
      }, 1);
    }
  ...
  useUpdateEffect(function() {
    ...
    if (activeItemState) {
      bindListeners();
      if (!isMobileMode) {
        ZIndexUtils.set("menu", currentPanel, context && context.autoZIndex || PrimeReact2.autoZIndex, context && context.zIndex.menu || PrimeReact2.zIndex.menu);
      }
    } else {
      unbindListeners();
    }
  ...
  var createSubmenuIcon = function createSubmenuIcon2(item) {
    if (item.items) {
      ...
      var icon = vertical ? props.submenuIcon || React8.createElement(AngleRightIcon, submenuIconProps) : props.submenuIcon || React8.createElement(AngleDownIcon, submenuIconProps);
      var submenuIcon = IconUtils.getJSXIcon(icon, _objectSpread4({}, submenuIconProps), {
        props
      });
      return submenuIcon;
    }
  ...
  var createSubmenuItem = function createSubmenuItem2(processedItem, index) {
    ...
    var icon = IconUtils.getJSXIcon(item.icon, _objectSpread4({}, iconProps), {
      props
    });
    ...
    var submenuItemProps = mergeProps2({
      key,
      id: key,
    ...
    var content = React8.createElement("a", actionProps, icon, label, React8.createElement(Ripple, null));
    if (item.template) {
    ...
    return React8.createElement("li", submenuItemProps, React8.createElement("div", contentProps, content));
  };
  var createSubmenu = function createSubmenu2(submenu, index) {
    ...
    var submenuHeaderProps = mergeProps2({
      id: key,
      key,
    ...
    return React8.createElement(React8.Fragment, {
      key
    }, React8.createElement("li", submenuHeaderProps, label), items);
  };
  ...
  var createColumn = function createColumn2(processedItem, processedColumn, index) {
    ...
    return React8.createElement("div", columnProps, React8.createElement("ul", submenuProps, submenus));
  };
  ...
  var createCategoryPanel = function createCategoryPanel2(processedItem) {
    ...
    if (category.items) {
      ...
      var gridProps = mergeProps2({
        className: cx("grid")
      }, ptm("grid"));
      return React8.createElement("div", panelProps, React8.createElement("div", gridProps, columns));
    }
    return null;
  };
  var createStyle = function createStyle2() {
    if (!styleElementRef.current) {
      styleElementRef.current = DomHandler.createInlineStyle(context && context.nonce || PrimeReact2.nonce, context && context.styleContainer);
  ...
  var createCategory = function createCategory2(processedItem, index) {
    ...
    var icon = IconUtils.getJSXIcon(category.icon, _objectSpread4({}, iconProps), {
      props
    });
    var labelProps = mergeProps2({
      className: cx("label")
    }, getPTOptions(processedItem, "label", index));
    var label = category.label && React8.createElement("span", labelProps, category.label);
    var submenuIcon = createSubmenuIcon(category);
    var panel = createCategoryPanel(processedItem);
    var headerActionProps = mergeProps2({
      href: category.url || "#",
      className: cx("action", {
        item: category
      }),
    ...
    var itemContent = category.template ? ObjectUtils.getJSXElement(category.template, category, headerActionProps) : React8.createElement("a", headerActionProps, icon, label, submenuIcon, React8.createElement(Ripple, null));
    var key = getItemId(processedItem);
    var isFocused = isItemFocused(processedItem);
    var isDisabled = isItemDisabled(processedItem);
    var menuItemProps = mergeProps2(_defineProperty5({
      key,
      id: key,
    ...
    return React8.createElement("li", menuItemProps, React8.createElement("div", contentProps, itemContent), panel);
  };
  var createMenu = function createMenu2() {
    ...
    if (processedItems) {
      return React8.createElement("ul", menuProps, processedItems.map(function(item, index) {
  ...
  var createMenuButton = function createMenuButton2() {
    ...
    var menuButtonProps = mergeProps2({
    ...
    var menuButtonIconProps = mergeProps2(ptm("menuButtonIcon"));
    var icon = props.menuIcon || React8.createElement(BarsIcon, menuButtonIconProps);
    var menuIcon = IconUtils.getJSXIcon(icon, _objectSpread4({}, menuButtonIconProps), {
      props
    });
    var button = React8.createElement("a", _extends6({
      ref: menuButtonRef
  ...
  return React8.createElement("div", _extends6({
    id: props.id,
    ref: elementRef
