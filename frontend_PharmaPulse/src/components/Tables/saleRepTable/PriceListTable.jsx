...
const PriceListTable = () => {
  ...
  return (
    <div className='p-4 bg-gray-100 rounded-md shadow-md'>
      <h1 className='text-2xl font-bold mb-4 text-white bg-teal-800 p-3 rounded-t-md'>
        ...
        >
          <Table>
            <TableHead className='bg-orange-400 text-white'>
              <TableRow>
                <TableCell className='font-bold text-white border-2 border-gray-300'>
                  Product Name
                </TableCell>
                <TableCell className='font-bold text-white border-2 border-gray-300'>
                  Code
            ...
            <TableBody className='bg-blue-100'>
              {filteredProducts.map((product) => (
                <TableRow
                  key={product.id}
                  className='hover:bg-blue-200 border-2 border-gray-300'
                >
