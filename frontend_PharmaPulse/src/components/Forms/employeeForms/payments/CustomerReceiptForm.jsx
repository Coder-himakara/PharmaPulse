...
const CustomerReceiptForm = ({ onAddReceipt }) => {
  ...
  return (
    <div className="relative">
      ...
      {/* Success Popup Modal with Blue Theme */}
      {showPopup && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="relative p-6 text-center bg-white rounded-lg shadow-lg w-80">
            ...
            <button
              ...
              className="px-6 py-2 mt-4 text-white transition-all duration-300 bg-blue-500 rounded-md hover:bg-blue-600"
            >
              CONTINUE
            </button>
          </div>
